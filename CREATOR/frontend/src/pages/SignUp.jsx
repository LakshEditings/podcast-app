...
export default function SignUp() {
    ...
    const handleSignUp = (e) => { e.preventDefault(); setLoading(true); setTimeout(() => { setLoading(false); navigate('/'); }, 1200); };
      ...
      `}</style>
            <div className="auth-page">
                ...
                <div className="auth-container fade-in">
                    ...
                    <p className="auth-subtitle">Start sharing your voice</p>
                    <form onSubmit={handleSignUp}>
                        <div className="input-group"><FiUser className="input-icon" /><input type="text" placeholder="Channel name" value={name} onChange={e => setName(e.target.value)} required /></div>
                    ...
                    <p className="auth-link">Already a creator? <Link to="/login">Sign In</Link></p>
                </div>
            </div>
        </>
    );
